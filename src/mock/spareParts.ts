...
export const mockSparePartRequests: SparePartRequest[] = [
  {
    ...
    deviceId: 'd005',
    items: [
      { sparePartId: 'sp-005', name: '砂轮主轴轴承', quantity: 1, unit: '套', unitPrice: 1280 },
    ],
    totalAmount: 1280,
    status: 'pending',
    createdAt: '2025-06-16T08:30:00Z',
  },
  {
    ...
    deviceId: 'd003',
    items: [
      { sparePartId: 'sp-001', name: '导轨润滑脂', quantity: 2, unit: 'kg', unitPrice: 85 },
      { sparePartId: 'sp-003', name: '液压油滤芯', quantity: 1, unit: '个', unitPrice: 120 },
    ],
    totalAmount: 290,
    status: 'completed',
    approverId: 'u001',
  ...
  },
  {
    ...
    deviceId: 'd001',
    items: [
      { sparePartId: 'sp-001', name: '导轨润滑脂', quantity: 3, unit: 'kg', unitPrice: 85 },
      { sparePartId: 'sp-002', name: '主轴轴承', quantity: 2, unit: '个', unitPrice: 450 },
    ],
    totalAmount: 1155,
    status: 'approved',
    approverId: 'u001',
